      ...
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md m-4 transform transition-all duration-300">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="tagColor" className="block text-sm font-medium text-slate-700 mb-1">Color</label>
              <input
                type="color"
                id="tagColor"
                {...register('color')}
                className="w-full h-10 px-1 py-1 border border-slate-300 rounded-md"
              />
            </div>
