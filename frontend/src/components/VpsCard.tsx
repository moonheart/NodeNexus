...
const VpsCard: React.FC<VpsCardProps> = ({ server }) => {
  ...
  return (
    <TooltipProvider>
      <Card className={cn("flex flex-col transition-shadow duration-300 hover:shadow-lg", cardBorderClass)}>
        <RouterLink to={`/vps/${server.id}`} className="hover:bg-muted/50 transition-colors">
          <CardHeader className="pb-2">
            <div className="flex items-start justify-between">
              ...
              <Badge variant={statusVariant} className="flex-shrink-0 ml-2">
        ...
        <CardFooter className="flex justify-between text-xs text-muted-foreground pt-2 pb-3 px-4 border-t">
