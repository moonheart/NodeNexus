...
impl ConnectionHandler {
    ...
    async fn connect_and_handshake_grpc(
        ...
        let channel = tonic::transport::Endpoint::from_shared(agent_cli_config.server_address.clone())?
            .tls_config(tls)?
        ...
        let stream_response_future = client.establish_communication_stream(tokio_stream::wrappers::ReceiverStream::new(rx_for_stream));
