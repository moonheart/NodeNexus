...
impl From<crate::agent_service::AgentConfig> for WebAgentConfig {
    fn from(proto: crate::agent_service::AgentConfig) -> Self {
        Self {
...
impl From<WebAgentConfig> for crate::agent_service::AgentConfig {
...
impl From<crate::agent_service::ServiceMonitorTask> for WebServiceMonitorTask {
    fn from(proto: crate::agent_service::ServiceMonitorTask) -> Self {
        Self {
...
impl From<WebServiceMonitorTask> for crate::agent_service::ServiceMonitorTask {
